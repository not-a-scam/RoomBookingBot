...
DATE_MSG = "*Enter time room should be booked for* (e.g. 430pm - 6pm)"
TIME_MSG = "*Enter the reason for room booking*"
PURPOSE_MSG = "*Do you need a screen?* (Enter yes or no)"
SCREEN_MSG = "*Enter extra requests or NA if none*"
